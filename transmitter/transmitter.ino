...
#define tunnel1 "PIPE1"     // We define the first name of pipe (5 characters) to be able to send data to the other NRF24
#define tunnel2 "PIPE2"     // We define the second name of pipe (5 characters) to be able to send data to the other NRF24
...
int ledState = 1; // state of the led (1 if on, 0 if off)
